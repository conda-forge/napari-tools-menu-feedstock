...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-tools-menu-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15165&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-tools-menu-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-tools-menu` can be installed with:

```
conda install napari-tools-menu
```

It is possible to list all of the versions of `napari-tools-menu` available on your platform with:
